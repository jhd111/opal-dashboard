...
// fetch Services
  ...
  const {
    ...
    isLoading,
    error,
  } = fetchResults("our-inventory", "/api/admin/add-inventory-by-admin/")
  ...
  SearchResults("our-inventory", "/api/admin/match-name-in-voucher-inventory/", debouncedSearchTable1);

  const columns = [
    { label: "No.", accessor: "no" },
    { label: "Service Name", accessor: "serviceName" },
    { label: "Expiry Date", accessor: "expiryDate" },
    { label: "Voucher File", accessor: "voucherFile" },
...
// --------------------------delete result---------------------
const { mutate: deleteResult } = useDeleteResultMutation(["our-inventory"]);
