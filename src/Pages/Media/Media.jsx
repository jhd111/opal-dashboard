...
//     "Hero Banner": `${Base_url}/api/admin/delete-home-image/`,
//     "Media Gallery": `${Base_url}/api/admin/delete-media-gallery/`,
//     "Awards & Certificates": `${Base_url}/api/admin/delete-certification-award/`,
//   };
...
//       // Handle deletions first if any
//       if (imagesToDelete.length > 0) {
//         const deletePromises = imagesToDelete
//           .filter(item => item.tab === activeTab)
//           .map(async (item) => {
//             try {
//               await axios.delete(`${deleteEndpoints[activeTab]}${item.id}/`, {
//                 headers: {
//                   Authorization: `Token ${token}`,
//                 },
//               });
//             } catch (error) {
//               console.error(`Failed to delete image ${item.id}:`, error);
//               throw error;
//             }
//           });
...
//       toast.success(`${activeTab} images updated successfully!`);
      
//       // Clear new uploads and deletion list
//       setTabImages(prev => ({
//         ...prev,
//         [activeTab]: []
//       }));
//       setImagesToDelete(prev => prev.filter(item => item.tab !== activeTab));
...
//       // Add to deletion list for API call
//       setImagesToDelete(prev => [...prev, { id: originalId, tab: activeTab }]);
...
//   const mainImage = allImages.length >= 4 ? allImages[3] : null;
...
//       {/* Status indicator */}
//       {imagesToDelete.filter(item => item.tab === activeTab).length > 0 && (
//         <div className="mb-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
//           <p className="text-sm text-yellow-700">
//             {imagesToDelete.filter(item => item.tab === activeTab).length} image(s) marked for deletion. Click "Publish Changes" to confirm.
//           </p>
//         </div>
//       )}
